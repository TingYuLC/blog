...
**weex采用webpack配置，对前端开发者特别友好，分包简单，而react-native需要额外制作分包打包工具，麻烦。**

## 调试

**weex采用weex debug和weex playgroud，react-native采用react-native-debuger**

**亲身体验：weex和react-native调试都是大坑，weex 调试的安装会报更种莫名其妙的错误，而且weex playground无法调试js，network也无法调试post请求，而react-native-debuger有很多第三方库没支持，比如安装relam数据库，会导致debuger无法使用等等。**
...
|   特点   |     <font color="blue">适合单页面</font>      |  <font color="blue">适合开发整体App</font>  |
...
**1.weex Android页面跳转问题，需在android目录下新增Activity进行file://拦截，采用file:// 名跳转，但由于android 7开始不支持file://，所以还需额外配置参数支持**。

**2.weex 没有暴露status的api，导致无法在每个页面更改status，只能在app配置里初始化配置一次。**

**3.如果你的手机装了两个或者多个weex app，当你进行navigator跳转的时候，会弹出应用选择框，用户体验极差。。。**

<img src="/img/weex_react-native/1.jpg" width="200px"/>
...
| <center><img src="/img/weex_react-native/2.png" width="200px"/>weex 图1</center> | <center><img src="/img/weex_react-native/3.png" width="200px"/>weex 图2</center> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| <center><img src="/img/weex_react-native/4.png" width="200px"/>react-native 图1</center> | <center><img src="/img/weex_react-native/5.jpg" width="200px"/>react-native 图2</center> |
| <center><img src="/img/weex_react-native/6.jpg" width="200px"/>react-native 图3</center> | <center><img src="/img/weex_react-native/7.jpg" width="200px"/>react-native 图4</center> |
